...
tasks.register<GenerateTask>("openApiGenerateApiPublic") {
    ...
    packageName.set("org.anasoid.jmeter.cloud.public.rest.generated")
    configOptions.set(
        mapOf(
            "basePackage" to "org.anasoid.jmeter.cloud.public.rest.generated.app",
